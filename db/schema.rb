...
ActiveRecord::Schema.define(version: 2021_03_02_095435) do
  ...
  create_table "buyer_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_history_id"], name: "index_buyer_addresses_on_purchase_history_id"
  end
  ...
  add_foreign_key "buyer_addresses", "purchase_histories"
